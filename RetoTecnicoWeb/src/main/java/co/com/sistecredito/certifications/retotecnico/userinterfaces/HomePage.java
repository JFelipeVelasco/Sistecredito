...
public class HomePage {
    ...
    public static final Target CLOTHING_CATE = Target.the("Clothing category").locatedBy("//p[contains(text(),'Decohogar')]");
    public static final Target FURNITURE_ITEM = Target.the("Bedroom item").locatedBy("//a[contains(text(),'Camas')]");
    public static final Target SPORTS_ITEM = Target.the("Sports item").locatedBy("//a[contains(text(),'Candados')]");
    public static final Target CLOTHING_ITEM = Target.the("Clothing item").locatedBy("//a[contains(text(),'Libros')]");
}
