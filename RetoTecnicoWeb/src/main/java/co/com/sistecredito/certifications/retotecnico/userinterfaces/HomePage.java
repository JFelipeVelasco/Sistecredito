...
public class HomePage {
    ...
    public static final Target HOME_CATE = Target.the("Clothing category").locatedBy("//p[contains(text(),'Decohogar')]");
    ...
    public static final Target HOME_ITEM = Target.the("Clothing item").locatedBy("//a[contains(text(),'Libros')]");
}
