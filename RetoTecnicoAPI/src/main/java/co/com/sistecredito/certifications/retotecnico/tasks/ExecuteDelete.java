...
public class ExecuteDelete implements Task {
    ...
    public ExecuteDelete(Map<String, String> data) {
        this.data = data;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Delete.from(PATH + "/" + data.get(ID)).with(requestSpecification -> requestSpecification
    ...
    public static ExecuteDelete with(Map<String, String> data) {
        return instrumented(ExecuteDelete.class, data);
    }
}
